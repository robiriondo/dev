...
function initMap() {
  ...
  // End Additions */
    L.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/toner-lite/{z}/{x}/{y}{r}.{ext}', { //Gray tiles
    //L.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/toner/{z}/{x}/{y}{r}.{ext}', { //Black tiles
    //L.tileLayer('https://tile.thunderforest.com/transport/{z}/{x}/{y}.png?apikey=e1afe91e75634f3d9d1056b779bb9bf1',{ //Blue tiles
    ...
    function style(feature) {
        return {
            ...
            opacity: 1,
            color: 'black',
            dashArray: '3', // Border surrounding map areas
            fillOpacity: 0.85
        };
    }
    ...
    */
    ...
    function highlightFeature(e) {
        ...
        layer.setStyle({
            weight: 5,
            color: '#fff', // Color of the highlight border when hovering through an area.
            dashArray: '',
            fillOpacity: .9
        });
        ...
        //info.update(layer.feature.properties); // Shows area info when hovering over them
    }
    ...
    function zoomToFeature(e) {
        var layer = e.target;
        //map.fitBounds(layer.getBounds()); // Zoom to area and bring area to front
    ...
    */
    ...
    // L.control.layers(overlayMaps).addTo(map); //Checkboxes
    L.control.layers(overlayMaps).addTo(map); //Radiobuttons
    ...
    legend.onAdd = function(map) {
        ...
        var div = L.DomUtil.create('div', 'info legend')
          ,
        grades = [0.1, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4]
